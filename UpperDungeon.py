...
#            for i in range(1, Settings.UpperDungeon[Settings.UpperDungeon_sHardContentNoOfTimesToRetry]) :
...
def gen_upper_dungeon():
    ...
    UpperDungeon_SelectEasyContentHeroesAt = 1  # Select heroes for easy content
    UpperDungeon_SelectHardContentHeroesAt = 8  # Select heroes for hard content (Chapter 8)
    Common.Gen_Conquest_UpperDungeon_Helper('upper_dungeon',    # Portal > UpperDungeon
                                            chapterList,
                                            longestRunTimeList,
                                            Settings.UpperDungeon[Settings.UpperDungeon_sHighestClearedChapter],
                                            Settings.UpperDungeon[Settings.UpperDungeon_sHardContentNoOfTimesToRetry],
                                            UpperDungeon_SelectEasyContentHeroesAt,
                                            UpperDungeon_SelectHardContentHeroesAt)
